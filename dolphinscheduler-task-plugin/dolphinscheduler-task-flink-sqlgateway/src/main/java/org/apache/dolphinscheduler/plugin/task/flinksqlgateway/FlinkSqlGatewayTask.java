...
public class FlinkSqlGatewayTask extends AbstractTask {
    ...
    public void init() {
        ...
        // DS variable replacement: ${system.biz.date} etc.
        if (parameters != null) {
            ...
            if (paramsMap != null && !paramsMap.isEmpty()) {
                ...
                if (StringUtils.isNotBlank(parameters.getInitScript())) {
                    parameters.setInitScript(
                            ParameterUtils.convertParameterPlaceholders(parameters.getInitScript(), stringParams));
                }
                if (StringUtils.isNotBlank(parameters.getRawScript())) {
                    parameters.setRawScript(
                            ParameterUtils.convertParameterPlaceholders(parameters.getRawScript(), stringParams));
                }
            }
        }
